...
/**
 * This java class is used to show the Casual Shirt Fragment page.
 */
public class CasualShirtFragment extends Fragment {
    ...
    /**
     * is an override method and used to inflate the casual shirt fragment
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.casualShirtRecyclerView);
        recyclerView.setLayoutManager(layoutManager);
        itemsList = new ArrayList<>();
        db.collection("CasualShirts")
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter.setOnItemClickListener(new RecycleAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                Bundle b = new Bundle();
                                b.putParcelable("casual", itemsList.get(position));
                                b.putString("collection","CasualShirts");
                            ...
                            public void onImageClick(int position, ImageView imageView ) {
                                ...
                                db.collection("CasualShirts").document(item.getId())
                                        .set(item)
