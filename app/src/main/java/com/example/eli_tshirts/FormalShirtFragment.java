...
/**
 *This java class is used to show the FormalShirtFragment page.
 */
public class FormalShirtFragment extends Fragment {
    ...
    /**
     * is an override method and used to inflate the formal shirt fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_formal_shirt, container, false);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.formalShirtRecyclerView);
        recyclerView.setLayoutManager(layoutManager);
        itemsList = new ArrayList<>();
        db.collection("FormalShirts")
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter.setOnItemClickListener(new RecycleAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                Bundle b = new Bundle();
                                b.putParcelable("formal", itemsList.get(position));
                                b.putString("collection","FormalShirts");
                            ...
                            public void onImageClick(int position, ImageView imageView ) {
                                ...
                                db.collection("FormalShirts").document(item.getId())
                                        .set(item)
