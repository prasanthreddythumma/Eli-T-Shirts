...
/**
 * This java class is used to show the Others Fragment page.
 */
public class OthersFragment extends Fragment {
    ...
    /**
     * is an override method and used to inflate the others fragment
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.othersRecyclerView);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter.setOnItemClickListener(new RecycleAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                Bundle b = new Bundle();
                                b.putParcelable("other", itemsList.get(position));
                                b.putString("collection","Others");
                            ...
                            public void onImageClick(int position, ImageView imageView ) {
                                ...
                                db.collection("Others").document(item.getId())
                                        .set(item)
